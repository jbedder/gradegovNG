...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/gradegovNG/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/gradegovNG/wp-admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);function initMap(map,position,zoom){map.setCenter(position);map.setZoom(zoom);var marker=new google.maps.Marker({position:position,map:map});}var wpAjaxUrl='http://localhost/gradegovNG/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/gradegovNG/wp-content/plugins/beaver-builder-lite-version/';